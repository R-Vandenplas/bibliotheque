...
public class Gestion {
    ...
    public static void main(String[] args) {
        ...
        int choix;
        do {
            System.out.println("1.Ajout Auteur 2.Ajout Ouvrage 3.Ajout Lecteur 4.Ajout Rayon 5.Ajout Exemplaire 6.Louer 7.Rendre 8.fin");
            choix= sc.nextInt();
            switch (choix){
                case 1: gestAuteur();break;
                case 2: gestOuvrage();break;
                case 3: addLecteur();break;
                case 4: addRayon();break;
                case 5: addEx();break;
                case 6: louer();break;
                case 7: rendre();break;
